//---------------------------------------------------------------------------------------
// adapted from X2TargetingMethod_MeleePath.uc from the core game.
// Holy Strike, by default, is designed to function identically to the ranger melee. The exception
// is that its range is capped at the length of a single (blue) move.
//---------------------------------------------------------------------------------------

class X2TargetingMethod_HolyStrike extends X2TargetingMethod;
...
function Init(AvailableAction InAction, int NewTargetIndex)
{
	...
	`LOG("PaladinClass: Initializing Holy Strike targeting method.");
